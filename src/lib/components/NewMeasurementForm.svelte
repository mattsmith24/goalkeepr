...
{#if open}
    <form method="POST" action="?/createMeasurement">
        ...
        <input id="measurement-description" name="measurement-description" class="border border-gray-500"/>
        <input type="submit" value="Add Measurement" class="text-blue-800 hover:underline"/>
